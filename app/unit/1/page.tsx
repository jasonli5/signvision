    ...
    <>
      ...
      <div className="flex items-center justify-center">
        <Link
          ...
          className="flex items-center justify-center rounded-lg text-xl text-white bg-red-500 hover:bg-red-700 py-4 px-6 mt-12"
        >
          Test your skills
        </Link>
      </div>
...
export const LessonButton = ({ lesson, description }: LessonButtonProps) => {
  return (
    <Link
      href={`1/${lesson}`}
      className="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded-full h-32 w-32 flex justify-center items-center flex-col"
    >
